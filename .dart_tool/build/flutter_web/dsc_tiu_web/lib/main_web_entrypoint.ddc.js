define(['dart_sdk', 'packages/dsc_tiu_web/main'], function(dart_sdk, packages__dsc_tiu_web__main) {
  'use strict';
  ...
  const main = packages__dsc_tiu_web__main.main;
  ...
  dart.trackLibraries("packages/dsc_tiu_web/main_web_entrypoint", {
    "package:dsc_tiu_web/main_web_entrypoint.dart": main_web_entrypoint
  }, {
