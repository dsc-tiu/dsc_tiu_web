...
let modulePaths = {
 ...
 "packages/dsc_tiu_web/main": "packages/dsc_tiu_web/main.ddc",
 "packages/dsc_tiu_web/main_web_entrypoint": "packages/dsc_tiu_web/main_web_entrypoint.ddc",
 "packages/dsc_tiu_web/screens/event_screen": "packages/dsc_tiu_web/screens/event_screen.ddc",
 "packages/dsc_tiu_web/screens/gallery_screen": "packages/dsc_tiu_web/screens/gallery_screen.ddc",
...
define("main_web_entrypoint.dart.bootstrap", ["packages/dsc_tiu_web/main_web_entrypoint", "dart_sdk"], function(app, dart_sdk) {
  ...
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "package:dsc_tiu_web/main_web_entrypoint.dart") {
          // Clear static caches.
